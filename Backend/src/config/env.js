...
export const config = {
    ...
    // SMSIndiaHub
    smsIndiaHubApiKey: process.env.SMSINDIAHUB_API_KEY || process.env.SMSINDIAHUB_KEY || '14sz4JWct0y6Ol8vjQ296A',
    smsIndiaHubSenderId: process.env.SMSINDIAHUB_SENDER_ID || 'MAAVA',
...
export const updateConfig = () => {
    ...
    config.smsIndiaHubApiKey = process.env.SMSINDIAHUB_API_KEY || process.env.SMSINDIAHUB_KEY || config.smsIndiaHubApiKey;
